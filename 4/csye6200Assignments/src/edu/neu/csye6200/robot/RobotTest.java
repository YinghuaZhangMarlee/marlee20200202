...
//assignment2a  	• use the ‘new’ operation with your  Robot constructor  to generate five instances of  a Robot.
    ...
    public void sampleRobots() {
        ...
        this.robotList[6] = new Robot("BBB", "Marlee", "(1,2)", 45, 3, 19, 3, 5);
        this.robotList[7] = new Robot("CCC", "Marlee", "(3,4)", 30, 5, 19, 7, 2);
        this.robotList[8] = new Robot("DDD", "Marlee", "(-5,6)", 90, 6, 22, 5, 5);
        this.robotList[9] = new Robot("EEE", "Marlee", "(7,8)", 180, 9, 25, 8, 10);
    }
