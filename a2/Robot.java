...
//	• Add Strings for the robot name and manufacturer
	
	String name;
	String manufacture;
	
//	• Add values for the position (X, Y), heading (in degrees), and speed
...
//	• Add values for weight (i.e. total mass Kg), engine power draw (mA), battery capacity (mA-Hour)
	int weight;
	int enginePowerDraw;
	int batteryCapacity;
...
//	• Add getter and setter methods for major  variables
	...
	/**
	 * Generate a formatted Robot string
...
//	• Add a  “ moveTo ”  method that moves your robot and prints the cell boundary transitions
	public void moveTo() {
		double i;
		double j;
		double distance ;
